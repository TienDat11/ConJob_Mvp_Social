import { DialogHeader, Dialog, DialogTitle, DialogContent, DialogFooter } from "@/components/ui/dialog";
...
interface AvatarInputProps {
  ...
  onImageCropped: (biob: Blob | null) => void;
}
...
function AvatarInput({src, onImageCropped} : AvatarInputProps) {
  ...
  return <>
    ...
    >
      ...
      />
      <span className="absolute inset-0 m-auto flex size-12 items-center justify-center rounded-full bg-black bg-opacity-30 text-white transition-colors duration-300 group-hover:bg-opacity-25">
        <Camera size={24} />
      </span>
    </button>
    {imageToCrop && (
