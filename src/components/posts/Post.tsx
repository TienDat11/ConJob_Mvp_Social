  ...
  return (
    <article className="group/post space-y-3 rounded-2xl bg-card p-5 shadow-sm">
      ...
      <BookmarkButton 
        postId={post.id}
        initialState={{
          isBookmarkInfo: post.bookmarks.some(bookmark => bookmark.userId === user.id),
        }}
      />
      </div>
...
function CommentButton({post, onClick}: Readonly<CommentButtonProps>) {
  return <button onClick={onClick} className="flex items-center gap-3">
